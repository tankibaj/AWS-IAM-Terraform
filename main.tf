...
module "iam_user" {
  ...
  # Dcrypted password "terraform output -raw this_iam_user_login_profile_encrypted_password | base64 --decode | keybase pgp decrypt"
  # Dcrypted access key "terraform output -raw this_iam_access_key_encrypted_secret | base64 --decode | keybase pgp decrypt"
